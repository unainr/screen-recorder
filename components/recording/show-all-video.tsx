				...
				<div
					...
					<div className="flex items-start gap-2.5">
						...
						{/* <button
							...
							className="w-7 h-7 rounded-lg flex items-center justify-center text-zinc-400 hover:text-violet-500 hover:bg-violet-50 dark:hover:bg-violet-500/10 transition-all disabled:opacity-40">
							{transcribingId === video.id ||
							video.transcriptStatus === "pending" ? (
