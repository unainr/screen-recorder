...
const Shade = () => {
  return (
    <div className="relative w-full h-162.5 overflow-hidden rounded-xl">

      {/* Shader fills entire container as background */}
      <div className="absolute inset-0">
        <ShaderAnimation />
      </div>

      {/* Dark gradient overlay so text is readable */}
      <div className="absolute inset-0 bg-linear-to-t from-black/70 via-black/30 to-black/10 z-10 pointer-events-none" />
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-auto">
        <div className="text-center max-w-4xl px-6">
          ...
          {/* Headline */}
          <motion.h1
            className="text-5xl lg:text-7xl font-extrabold mb-5 leading-[1.08] tracking-tight text-white"
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              <motion.span
                className="absolute -bottom-1 left-0 h-0.75 w-full rounded-full bg-linear-to-r from-orange-400 to-amber-300 opacity-70"
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
